...
export default function ExperienceSection() {
  return (
    <section className="bg-[#f1f3f1] section-padding overflow-hidden">
        ...
        <div className="mt-12 grid grid-cols-2 gap-3 sm:mt-16 sm:gap-4 lg:grid-cols-5">
          {experiences.map((exp, idx) => (
            <Card
              key={idx}
              className={cn(
                "group relative overflow-hidden rounded-3xl border-none bg-background transition-all duration-300 hover:bg-muted/50 hover:shadow-lg",
