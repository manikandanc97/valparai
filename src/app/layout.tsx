...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://images.pexels.com/photos/9766221/pexels-photo-9766221.jpeg",
        width: 1200,
        height: 630,
      },
    ],
  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      >
        ...
        <a
          href="https://wa.me/917904199605?text=Hello%20Valparai%20Wanderer%20Tours%2C%20I%20would%20like%20to%20book%20a%20tour%20package."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg transition-all hover:scale-110 hover:rotate-6 hover:shadow-2xl sm:bottom-8 sm:right-8 sm:h-16 sm:w-16"
