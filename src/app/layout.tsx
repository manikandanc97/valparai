    ...
    <html lang="en" className="scroll-smooth" suppressHydrationWarning>
      ...
      >
        ...
        <a
          ...
          className="fixed bottom-5 right-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25d366] text-white shadow-lg transition-all hover:scale-105 sm:bottom-7 sm:right-7"
